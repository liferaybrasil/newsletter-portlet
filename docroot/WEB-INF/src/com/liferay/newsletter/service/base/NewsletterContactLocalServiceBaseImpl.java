...
/**
 * The base implementation of the newsletter contact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.newsletter.service.impl.NewsletterContactLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.newsletter.service.impl.NewsletterContactLocalServiceImpl
 * @see com.liferay.newsletter.service.NewsletterContactLocalServiceUtil
 * @generated
 */
public abstract class NewsletterContactLocalServiceBaseImpl
	implements NewsletterContactLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.newsletter.service.NewsletterContactLocalServiceUtil} to access the newsletter contact local service.
	 */
	 ...
	 */
	public NewsletterContact addNewsletterContact(
		NewsletterContact newsletterContact) throws SystemException {
		newsletterContact.setNew(true);

		newsletterContact = newsletterContactPersistence.update(newsletterContact,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(newsletterContact);
			}
	 ...
	 */
	public NewsletterContact createNewsletterContact(long contactId) {
		return newsletterContactPersistence.create(contactId);
	}
	...
	public void deleteNewsletterContact(long contactId)
		...
		NewsletterContact newsletterContact = newsletterContactPersistence.remove(contactId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(newsletterContact);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteNewsletterContact(NewsletterContact newsletterContact)
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return newsletterContactPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return newsletterContactPersistence.countWithDynamicQuery(dynamicQuery);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public NewsletterContact getNewsletterContact(long contactId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return newsletterContactPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<NewsletterContact> getNewsletterContacts(int start, int end)
		throws SystemException {
		return newsletterContactPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getNewsletterContactsCount() throws SystemException {
		return newsletterContactPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public NewsletterContact updateNewsletterContact(
		NewsletterContact newsletterContact) throws SystemException {
		return updateNewsletterContact(newsletterContact, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.newsletter.model.NewsletterContact",
			newsletterContactLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.newsletter.model.NewsletterContact");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = newsletterContactPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(NewsletterContactLocalServiceBaseImpl.class);
