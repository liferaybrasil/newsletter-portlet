...
public abstract class NewsletterLogLocalServiceBaseImpl
	...
	public NewsletterLog addNewsletterLog(NewsletterLog newsletterLog)
		...
		newsletterLog = newsletterLogPersistence.update(newsletterLog, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(newsletterLog);
			}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return newsletterLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public NewsletterLog updateNewsletterLog(NewsletterLog newsletterLog)
		throws SystemException {
		return updateNewsletterLog(newsletterLog, true);
	}
	...
	public NewsletterLog updateNewsletterLog(NewsletterLog newsletterLog,
		...
		newsletterLog = newsletterLogPersistence.update(newsletterLog, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.newsletter.model.NewsletterLog",
			newsletterLogLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.newsletter.model.NewsletterLog");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(NewsletterLogLocalServiceBaseImpl.class);
