...
public class SendCampaignPersistenceImpl extends BasePersistenceImpl<SendCampaign>
	...
	public SendCampaign remove(long sendCampaignId)
		...
		try {
			...
			return sendCampaignPersistence.remove(sendCampaign);
		}
	...
	/**
	 * Removes the send campaign from the database. Also notifies the appropriate model listeners.
	 *
	 * @param sendCampaign the send campaign to remove
	 * @return the send campaign that was removed
	 * @throws SystemException if a system exception occurred
	 */
	public SendCampaign remove(SendCampaign sendCampaign)
		throws SystemException {
		return super.remove(sendCampaign);
	}
